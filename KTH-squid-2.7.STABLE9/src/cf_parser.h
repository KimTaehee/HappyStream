...
default_all(void)
{
	...
	default_line("logfile_daemon /home/slhyvaa/squid-2.7.STABLE9/libexec/logfile-daemon");
	default_line("cache_log /home/slhyvaa/squid-2.7.STABLE9/var/logs/cache.log");
	default_line("cache_store_log /home/slhyvaa/squid-2.7.STABLE9/var/logs/store.log");
	...
	default_line("mime_table /home/slhyvaa/squid-2.7.STABLE9/etc/mime.conf");
...
#endif
	default_line("pid_filename /home/slhyvaa/squid-2.7.STABLE9/var/logs/squid.pid");
	...
	default_line("netdb_filename /home/slhyvaa/squid-2.7.STABLE9/var/logs/netdb.state");
	...
	default_line("diskd_program /home/slhyvaa/squid-2.7.STABLE9/libexec/diskd-daemon");
#if USE_UNLINKD
	default_line("unlinkd_program /home/slhyvaa/squid-2.7.STABLE9/libexec/unlinkd");
#endif
#if USE_ICMP
	default_line("pinger_program /home/slhyvaa/squid-2.7.STABLE9/libexec/pinger");
#endif
	...
	default_line("icon_directory /home/slhyvaa/squid-2.7.STABLE9/share/icons");
	default_line("global_internal_static on");
	default_line("short_icon_urls off");
	default_line("error_directory /home/slhyvaa/squid-2.7.STABLE9/share/errors/English");
...
#if USE_DNSSERVERS
	default_line("cache_dns_program /home/slhyvaa/squid-2.7.STABLE9/libexec/dnsserver");
#endif
#if USE_DNSSERVERS
...
defaults_if_none(void)
{
	...
	if (check_null_cachedir(Config.cacheSwap)) {
		default_line("cache_dir ufs /home/slhyvaa/squid-2.7.STABLE9/var/cache 100 16 256");
	}
#if USE_WCCPv2
