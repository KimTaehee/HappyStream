...
public class ExcuteShell extends Activity {

    private RunAsyncTask mAsyncTask;
    String result;
    public ExcuteShell(Context context) {

    }


    protected void reconfigureServer(int resize, String path) {
    ...
    protected void killServer(String path){
    ...
    protected void cleanCache(String path){
